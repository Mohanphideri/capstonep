...
The Trip Maker includes an AI-style local travel architecture layer that parses natural-language briefs, extracts destinations/group size/duration/preferences/constraints, scores fleet fit, generates day-by-day plans, surfaces planning confidence, and offers alternative planning modes. It does not invent live hotel availability, pricing, or confirmed transport data.
