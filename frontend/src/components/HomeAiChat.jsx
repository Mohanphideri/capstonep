...
const ROUTE_LABELS = {
  ...
  "/why-us": "Why Kuwarji", "/location": "Location",
...
function renderAssistantText(text) {
  ...
  const pattern = /(\[[^\]]+\]\(\/[^)]+\)|\/(?:dashboard(?:\/[^\s.,!?;:]*)?|vehicles(?:\/[^\s.,!?;:]*)?|tour-packages(?:\/[^\s.,!?;:]*)?|trip-planner|about|faq|why-us|location|privacy-policy|cookie-policy|terms|cancellation-policy|refund-policy|login)(?=[\s.,!?;:]|$))/g;
