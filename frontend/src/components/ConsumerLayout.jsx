...
import WebsiteTour from "./WebsiteTour.jsx";
...
const NAV_GROUPS = [
  {
    label: "Overview",
    items: [
      { to: "/dashboard", label: "Dashboard", icon: "grid", end: true, tour: "dashboard" },
    ],
  },
  {
    label: "Plan & Travel",
    items: [
      { to: "/dashboard/trip-planner", label: "Trip Planner", icon: "compass", tour: "trip-planner" },
      { to: "/dashboard/vehicles", label: "Search Vehicles", icon: "truck", tour: "vehicles" },
      { to: "/dashboard/tour-packages", label: "Tour Packages", icon: "grid" },
      { to: "/dashboard/enquiries", label: "My Enquiries", icon: "message" },
      { to: "/dashboard/bookings", label: "My Bookings", icon: "calendar", tour: "bookings" },
    ],
  },
  {
    label: "Account",
    items: [
      ...
      { to: "/dashboard/profile", label: "Profile", icon: "user", tour: "profile" },
