...
export function VehicleEnquiryForm({ vehicle, vehicles, onSubmitted }) {
  ...
  async function handleSubmit(e) {
    ...
    if (tripDate && tripDate < TODAY) { setError("Please choose today or a future travel date."); return; }
    if (returnDate && returnDate < (tripDate || TODAY)) { setError("Return date cannot be before the travel date."); return; }
