...
// A brand-new customer (OTP-only signup, no name/email collected yet) must
// complete their profile before they can reach anything else in the
// customer portal — not just the booking flow. This blocks every
// /dashboard/* route uniformly, in one place, instead of leaving each
// page to remember to check for itself.
export function ProtectedRoute({ children }) {
  ...
  if (!user.name || !user.email) {
    return <ProfileCompletionModal onComplete={refresh} />;
  }
