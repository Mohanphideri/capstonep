...
export default function AdminBookingCreate() {
  ...
  async function handleSubmit(e) {
    ...
    if (journey.journeyStart < TODAY) { setError("Journey date cannot be in the past."); return; }
    if (journey.journeyEnd && journey.journeyEnd < journey.journeyStart) { setError("Return date cannot be before the journey date."); return; }
          ...
          <div className="ticket admin-table-card" style={{ marginBottom: "1rem" }}>
            ...
            <div className="admin-form-grid">
              ...
              <div className="admin-form-field">
                ...
                <input type="date" min={TODAY} className="admin-input" value={journey.journeyStart} onChange={(ev) => setJourney((j) => ({ ...j, journeyStart: ev.target.value }))} />
              </div>
              <div className="admin-form-field">
                <label className="otp-label-text">Return date (optional)</label>
                <input type="date" min={journey.journeyStart || TODAY} className="admin-input" value={journey.journeyEnd} onChange={(ev) => setJourney((j) => ({ ...j, journeyEnd: ev.target.value }))} />
              </div>
              <div className="admin-form-field">
