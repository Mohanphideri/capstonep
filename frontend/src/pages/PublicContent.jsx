...
export function AboutPage() {
  return <div className="page"><SiteBanner /><Navbar /><main className="public-page">
    <section className="public-hero container"><p className="eyebrow">About Kuwarji Travels</p><h1 className="public-title">A trusted travel partner, built on the road since 2000.</h1><p className="public-intro">Kuwarji Travels provides buses, cars and tempo travellers on rent for outstation journeys, group travel and local packages — with the discovery, planning, enquiries and bookings kept together in one simple platform.</p></section>

    <section className="container about-story-grid">
      <div className="about-story-copy">
        <p className="eyebrow">Our Story</p>
        <h2>Two decades on the road, one family of travellers.</h2>
        <p>
          <em>(Sample reference copy — replace with your own company history from Admin → Settings.)</em> Kuwarji
          Travels was started in the year 2000 with a handful of vehicles and a simple promise: get people where
          they're going, safely and on time. What began as a small local fleet has grown, trip by trip, into a
          full-service travel partner trusted by families, corporates and tour groups across the region.
        </p>
        <p>
          Over the years we've carried wedding parties to their venues, students on college excursions, families
          on hill-station holidays, and companies on multi-city business tours. That experience has shaped
          everything about how we operate today — from the way we maintain our vehicles to how quickly we respond
          to an enquiry.
        </p>
        <p>
          The legacy we've built is simple: reliable vehicles, drivers who know the routes, and a team that treats
          every booking — big or small — with the same care. As we grow our fleet and our tour packages, that's the
          one thing that hasn't changed since day one.
        </p>
        <div className="about-story-stats">
          <div><strong>2000</strong><span>Since</span></div>
          <div><strong>25+</strong><span>Years on the road</span></div>
          <div><strong>1000s</strong><span>Journeys completed</span></div>
        </div>
      </div>
      <div className="about-story-media">
        <img src="/about-story.jpg" alt="A Kuwarji Travels coach on the highway" loading="lazy" />
      </div>
    </section>

    <section className="container public-section-grid"><article className="public-info-card"><h2>Fleet-first planning</h2><p>Browse the live vehicle catalogue, compare capacity and comfort details, then send an enquiry for the journey you actually need.</p></article><article className="public-info-card"><h2>Trip Planner</h2><p>Tell us your route, group size and travel style and get a quick suggestion, then continue into the existing enquiry flow.</p></article><article className="public-info-card"><h2>Human support</h2><p>Enquiries and bookings remain visible in the customer portal so you can follow progress after you submit a request.</p></article></section>
  </main><Footer /></div>;
}
