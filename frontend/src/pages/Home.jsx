    ...
    <div className="page">
      ...
      {featuredReviews.length > 0 && (
        ...
        >
          ...
          <div
            className={`pride-marquee${featuredReviews.length > 4 ? " is-scrolling" : ""}`}
            aria-label="Customer reviews"
          >
            <div className={`pride-track${featuredReviews.length > 4 ? " is-scrolling" : ""}`}>
              {(featuredReviews.length > 4 ? [...featuredReviews, ...featuredReviews] : featuredReviews).map(
                (review, index) => (
                  <article
