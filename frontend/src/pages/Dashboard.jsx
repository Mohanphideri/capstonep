...
export default function Dashboard(){
  ...
  return <ConsumerLayout title="Dashboard">
    ...
    <section className="customer-welcome-banner"><div><h2>Welcome back, {displayName}! <span>👋</span></h2><p>Plan your next journey with us.</p></div><div className="customer-skyline" aria-hidden="true"><span className="city c1"/><span className="city c2"/><span className="city c3"/><span className="city c4"/><span className="bus-art">▰</span></div></section>
    ...
    <section className="customer-stat-grid">
      ...
      <Link to="/dashboard/trip-maker" className="customer-stat-card"><span className="customer-stat-icon violet"><Icon name="truck"/></span><span><small>Upcoming Trips</small><strong>{upcoming.length}</strong><em>Next 30 Days</em></span></Link>
    ...
    <section className="customer-quick-grid">
      ...
      <Link to="/dashboard/trip-maker" className="customer-quick-card"><span className="quick-violet"><Icon name="calendar"/></span><strong>Trip Maker</strong><small>Plan your own trip</small></Link>
