  ...
  return (
    <ConsumerLayout title="Booking details" lead="Your booking information, journey details, and support options.">
      <div className="booking-detail-main">
        <p className="eyebrow">
          <Link to="/dashboard/bookings" className="my-bookings-back">
            ← My Bookings
          </Link>
        </p>
            ...
            <div className="booking-detail-grid">
              <section className="ticket booking-detail-section">
                ...
                {booking.vehicles.map((v, i) => (
                  <div key={i} style={{ marginBottom: i < booking.vehicles.length - 1 ? "0.75rem" : 0 }}>
                    <p>{v.name}</p>
              ...
              {booking.invoice && (
                <section className="ticket booking-detail-section">
                  ...
                  <Link to="/dashboard/invoices" className="btn btn-outline" style={{ marginTop: "0.5rem" }}>
                    View invoices
                  </Link>
                </section>
              )}
