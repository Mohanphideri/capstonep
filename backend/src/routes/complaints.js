...
const { createComplaintNotification, notifyAdmin } = require("../lib/notify");
...
router.post("/", requireAuth, createRateLimit, async (req, res) => {
  try {
    ...
    createComplaintNotification("CREATED", complaint);
    notifyAdmin({
      type: "COMPLAINT_CREATED",
      title: "New issue reported",
      message: `${booking.customerSnapshot?.name || "A customer"} raised ticket ${ticketId}.`,
