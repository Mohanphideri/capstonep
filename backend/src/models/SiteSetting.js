...
const SiteSettingSchema = new mongoose.Schema(
  {
    ...
    homepage: {
      heroTitle: { type: String, default: "Travel Comfortably." },
      heroAccent: { type: String, default: "Travel With Confidence." },
      heroBody: { type: String, default: "Reliable buses, cars and tempo travellers for local, outstation and group travel." },
