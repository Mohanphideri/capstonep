...
//     invalidates the cookie instead of only marking a log row. Authentication
//     fails closed if this store cannot be checked.
const UserSessionSchema = new mongoose.Schema(
  {
    ...
    sessionType: { type: String, enum: ["access", "refresh"], default: "access", index: true },
