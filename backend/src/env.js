...
const env = {
  ...
  // Cloudinary is the production default. LOCAL is intentionally limited
  // to development or an explicitly configured persistent disk.
  get storageProvider() {
    return (process.env.STORAGE_PROVIDER || (this.nodeEnv === "production" ? "CLOUDINARY" : "LOCAL")).toUpperCase();
  },
