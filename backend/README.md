...
| `ADMIN_PHONE` | 10-digit mobile number for the bootstrap admin account. Defaults to `7206722799` if unset. |
| `ADMIN_PASSWORD` | Password for the bootstrap admin account. Defaults to `admin@123` if unset. **Change this via Render env vars before going live**, and change it again from inside the admin portal once you're in. |
